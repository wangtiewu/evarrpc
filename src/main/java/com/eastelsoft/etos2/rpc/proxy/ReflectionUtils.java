...
public class ReflectionUtils {
	...
	/**
	 * Gets field from class cls, either declared in cls or in one of its
	 * superclasses
	 * 
	 * @param cls
	...
	/**
	 * Gets method from class <code>clz</code> or any of its superclasses. If no
	 * method can be found <code>NoSuchMethodException</code> is raised.
	 * 
	 * @param clz
	...
	public static boolean isPrimitiveOrString(Class<? extends Object> clz) {
		...
		boolean isPrivate = clz.isPrimitive();
		if (isPrivate) {
			return true;
		}
		// 判断是否是Wrap
